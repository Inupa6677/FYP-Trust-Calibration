(define (problem p01-54)
 ...
 (:init 
   ...
   (up tile_1-2 tile_2-1)
   (up tile_1-3 tile_2-2)
   (up tile_1-4 tile_2-3)
   (up tile_2-2 tile_3-1)
   (up tile_2-3 tile_3-2)
   (up tile_2-4 tile_3-3)
   ...
   (down tile_2-1 tile_1-2)
   (down tile_2-2 tile_1-3)
   (down tile_2-3 tile_1-4)
   (down tile_2-4 tile_1-1)
   (down tile_3-1 tile_2-2)
   (down tile_3-2 tile_2-3)
   (down tile_3-3 tile_2-4)
   (down tile_3-4 tile_2-1)
   (down tile_4-1 tile_3-2)
   (down tile_4-2 tile_3-3)
   (down tile_4-3 tile_3-4)
